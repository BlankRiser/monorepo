...
export default function Page() {
  const posts = [...snippetsSource.getPages()].sort(
    (a, b) =>
  ...
  return (
    <main className="mx-auto w-full max-w-fd-container sm:px-4 md:py-12">
      <div
        ...
        style={{
          backgroundImage: [
            "radial-gradient(circle at 70% 10%, rgba(255,100,50,0.5), transparent)",
            "radial-gradient(circle at 0% 80%, rgba(190,255,0,0.5), transparent)",
            "radial-gradient(circle at 50% 50%, rgba(255,55,50,0.3), transparent)",
