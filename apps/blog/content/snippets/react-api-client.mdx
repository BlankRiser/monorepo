...
date: 2024-05-27
description: Custom Fetch api client for react 
...
```ts  title="api-client.ts" lineNumbers
...
```tsx title="Example usage in React" lineNumbers
useEffect(() => {
  const controller = new AbortController();
  
  apiClient // [!code focus]
    .get<RootObject>( // [!code focus]
      'https://api.restful-api.dev/objects/4', // [!code focus]
      controller.signal, // [!code focus]
    ) // [!code focus]
    .then((res) => { // [!code focus]
