...
description: GitHub CLI, a game-changer in managing multiple Git accounts, simplifies setup and account switching with finesse. 
...
```shellscript title="gh auth status"
github.com
